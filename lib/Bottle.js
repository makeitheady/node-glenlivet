...
Bottle.prototype.serve = function (overrides, callback) {
    ...
    this._runMiddleware('before request', bottleRequest, function () {
        _this._runMiddleware('request', bottleRequest, function (preResponse) {
            ...
            bottleRequest.exec(function (bottleResponse) {
                var respond = function () {
                    ...
                    _this._runMiddleware('after response', bottleRequest, bottleResponse);
                }
